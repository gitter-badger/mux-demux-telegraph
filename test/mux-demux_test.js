...
(function() {
  var MuxDemuxTelegraph, Q, assert, chai, expect, highlandDuplex, toCatchPromise, toPromise, __;
  ...
  describe("check lines test", function() {
    return it.only("check lines", function(done) {
      var createMyPostStation, dest1, dest2, duplex1, duplex2, p1, p2, postStation1, postStation2, src1, src2;
      src1 = __();
      src2 = __();
      dest1 = __();
      dest2 = __();
      dest1.pipe(src2);
      dest2.pipe(src1);
      duplex1 = highlandDuplex.makeDuplexStream(function() {
        return src1;
      }, function() {
        return dest1;
      });
      duplex2 = highlandDuplex.makeDuplexStream(function() {
        return src2;
      }, function() {
        return dest2;
      });
      ...
      p1 = toCatchPromise(postStation2.worker).then(function(v) {
        return expect('ololo 1').to.eql(v);
      });
      p2 = toCatchPromise(postStation2.backgroundPage).then(function(v) {
        return expect('ololo 2').to.eql(v);
      });
